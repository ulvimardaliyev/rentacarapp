...
import az.rentacar.authservice.entity.User;
import az.rentacar.authservice.repository.RoleRepository;
import az.rentacar.authservice.repository.UserRepository;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "mod":
                        Role modRole = roleRepository.findRoleByRoleName("MODERATOR")
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
